...
<form onSubmit={handleSubmitProfile} className="flex flex-col gap-5 p-10 flex-1">
...
<img className={`max-w-44 aspect-square rounded-full max-sm:mt-10 ${selectedImg && "rounded-full"} `} src={authUser?.profilePic || assets.logo_icon} alt="" />
</div>
   </div>
  )
}
