...
<div  className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
  {messages.map((mes, i) => (
       <div key={i} className={`flex item-end gap-2 justify-end ${mes.senderId !== authUser._id
        && "flex-row-reverse"
       }`}>
        {mes.image ? (
        ...
        <div className="text-center text-xs">
             <img src={mes.senderId === authUser._id ? authUser?.profilePic || assets.avatar_icon : selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-7 rounded-full' />
